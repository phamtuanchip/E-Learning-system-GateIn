...
public class Util {
	...
	public static final String E_LEARNING = "elearning";
	public static final String E_LEARNING_APP = "elearning_home";
	public static final String E_LEARNING_LESSON = "elearning_lesson";
	public static final String E_LEARNING_DOC = "elearning_document";
}
